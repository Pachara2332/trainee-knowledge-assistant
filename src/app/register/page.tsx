    ...
    <main className="assistant-grid min-h-screen overflow-hidden bg-[#151515] px-6 py-10 text-white">
      ...
      <section className="relative mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-xl flex-col justify-center">
        ...
        >
          ...
          <label className="mb-4 flex flex-col gap-2 text-sm font-semibold text-[#d6d6d6]">
            Name
            <input
          ...
          {error ? (
            <p className="mb-4 rounded-2xl border border-[#7f2d2d] bg-[#2a1414] px-4 py-3 text-sm font-semibold text-[#ffb4b4]">
              {errorMessage}
            </p>
          ) : null}

          <button className="h-14 w-full rounded-full border border-[#333] bg-[#f4f4f4] px-5 text-base font-semibold text-[#151515] transition hover:bg-white cursor-pointer">
            Create Account
          </button>
        </form>
